...
`$ bin/kafka-topics.sh --create --zookeeper localhost:2181 --replication-factor 1 --partitions 1 --topic dxsys`<br>
...
#### Message received from the 'dxsys' topic by the basic listeners with groups foo and bar
>Received Message in group 'foo': Hello, World!<br>
Received Message in group 'bar': Hello, World!

#### Message received from the 'dxsys' topic, with the partition info
...
>Received Message in filtered listener: Hello dxsys!
